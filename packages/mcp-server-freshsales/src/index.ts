...
import { listContactsTool } from './tools/listContacts.js';
import { updateContactTool } from './tools/updateContact.js';
import { deleteContactTool } from './tools/deleteContact.js';
import { createAccountTool } from './tools/createAccount.js';
import { getAccountTool } from './tools/getAccount.js';
import { listAccountsTool } from './tools/listAccounts.js';
import { updateAccountTool } from './tools/updateAccount.js';
import { createDealTool } from './tools/createDeal.js';
import { getDealTool } from './tools/getDeal.js';
import { listDealsTool } from './tools/listDeals.js';
import { updateDealTool } from './tools/updateDeal.js';
import { createLeadTool } from './tools/createLead.js';
import { getLeadTool } from './tools/getLead.js';
import { zodToMcpSchema, AnyMCPTool } from './tools/helpers.js';

const logger = createLogger('mcp-server-freshsales');
...
const port = process.env.PORT || 8081; // Using 8081 for Freshsales to not conflict with Notion
app.listen(port, () => {
  logger.info(`Freshsales MCP Server running on port ${port}`);
});

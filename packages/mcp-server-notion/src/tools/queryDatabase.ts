...
const queryDatabaseSchema = z.object({
  ...
  filter: z.unknown().optional().describe("Notion filter object (e.g. { property: 'Status', status: { equals: 'Done' } })"),
  sorts: z.array(z.unknown()).optional().describe("Notion sort array (e.g. [{ property: 'Name', direction: 'ascending' }])"),
  page_size: z.number().int().min(1).max(100).optional().describe("Number of items to return (default 50, max 100)"),
